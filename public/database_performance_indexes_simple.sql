-- ================================================================
-- ProVal HVAC - Database Performance Optimization Indexes (SIMPLE)
-- ================================================================
-- Compatible with MySQL 5.7+ without advanced features
...
-- 20. Ensure all foreign key relationships are indexed
...
-- 22. Equipment Search Optimization
...
-- 24. Equipment Technical Details
...
CREATE INDEX idx_equipments_area_served ON equipments (area_served(100));
