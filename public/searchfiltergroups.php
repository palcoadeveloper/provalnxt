...
<html lang="en">
  <head>
    ...
    function restoreSearchState() {
        ...
        if (restoreFlag === '1') {
            console.log('Restoring filter group search state from URL parameters');
            ...
            if (status && status !== '') {
                ...
                setTimeout(function() {
                    console.log('Auto-submitting restored filter group search');

                    // Show a brief notification that search is being restored
                    if (typeof Swal !== 'undefined') {
                        Swal.fire({
                            title: 'Restoring Search Results',
                            text: 'Taking you back to your previous filter group search...',
                            icon: 'info',
                            timer: 1500,
...
e.preventDefault();
		...
		$('#pleasewaitmodal').modal('show');
                     ...
                     setTimeout(function() {
                         ...
                         // Smooth scroll to results section when coming back from filter group details
                         const restoreFlag = getUrlParameter('restore_search');
                         if (restoreFlag === '1') {
                             setTimeout(function() {
