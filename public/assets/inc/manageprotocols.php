...
$('#addEntryBtn').click(function() {
  ...
  var fileInputSection =
    ...
    '</select></div>' +
    '<div class="col-sm"><button class="btn-remove-row ">Delete</button></div> <hr/></div></div>' +
    '</div>';

  // Append the new section to the container
  $('#searchaudittrail.php').append(fileInputSection);
  ...
  $('input[name="fileInput[]"]').last().on('change', function() {
    ...
    console.log("Employee:", selectedEmployee);
      ...
      $('#searchaudittrail.php').on('click', '.btn-remove-row', function() {
