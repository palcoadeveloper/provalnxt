...
where t1.equip_id=t2.equipment_id and routine_test_wf_id in (select routine_test_wf_id from tbl_routine_test_wf_tracking_details) and t1.routine_test_wf_status='Active' 
and t1.unit_id=".$_SESSION['unit_id']."

and routine_test_wf_id NOT IN
(
select routine_test_wf_id from tbl_routine_test_wf_tracking_details t, equipments e where
 t.equipment_id=e.equipment_id
 and
 
 routine_test_wf_id in (
