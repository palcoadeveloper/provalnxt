    ...
    try {
        ...
        $result = executeSecureTransaction(function() use ($validated_data) {
            ...
            DB::insert('equipments', [
                ...
                'validation_frequencies' => safe_get('validation_frequencies', 'string', ''),
                'starting_frequency' => safe_get('starting_frequency', 'string', ''),
    ...
    try {
        ...
        $result = executeSecureTransaction(function() use ($validated_data) {
            ...
            DB::query(
                ...
                safe_get('validation_frequencies', 'string', ''),
                safe_get('starting_frequency', 'string', ''),
